...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        if ($islem === 'sezon_olustur') {
            ...
            foreach (preg_split('/[\r\n,]+/', $grupMetni) as $grup) { $grup=trim($grup); if ($grup !== '') $pdo->prepare('INSERT INTO gruplar(lig_id,grup_adi,aciklama,sezon) VALUES(?,?,?,?)')->execute([$ligId,$grup,'',$sezon['sezon_adi']]); }
