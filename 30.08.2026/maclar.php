<?php
/**
 * Kullanıcılar için Maç Listesi - Sadece Oynanmış, Grup Filtreli
 */
require_once __DIR__ . '/config/config.php';
require_once __DIR__ . '/config/database.php';
require_once __DIR__ . '/includes/functions.php';

$sayfa_baslik = 'Karşılaşma Sonuçları';
$aktif = 'maclar';
...
// Sorgu: sadece oynanmış maçlar, isteğe bağlı grup filtresi
$sql = "
    SELECT m.*, 
...
$sql .= " ORDER BY m.tarih DESC, m.saat DESC";
...
<div class="container">
    ...
    <?php if (empty($maclar)): ?>
        <p>Bu gruba ait oynanmış maç bulunmuyor.</p>
    <?php else: ?>
