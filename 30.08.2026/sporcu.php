...
$turnuvaSt->execute([$id]); $sonTurnuvaAtisi = $turnuvaSt->fetch();
    ...
    <div class="sporcu-kart-duzeni">
        ...
        <aside class="sporcu-performans">
            ...
            <section class="card"><h2>Turnuva Performansı</h2>
                <?php if ($sonTurnuvaAtisi): ?>
                    <div class="performans-satir"><span>Son turnuva</span><b><?= e($sonTurnuvaAtisi['turnuva_adi']) ?></b></div>
                    <div class="performans-satir"><span>Son set puanı</span><b><?= (int)$sonTurnuvaAtisi['set_toplam'] ?></b></div>
                    <a class="mini-link" href="turnuva-mac.php?id=<?= (int)$sonTurnuvaAtisi['mac_id'] ?>">Karşılaşmayı görüntüle →</a>
